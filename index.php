...
if (! empty($_POST) && $_POST['login'] === 'valid_username' && $_POST['password'] === 'valid_password')
{
    $_SESSION['log'] = true;
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="config/loginetudiant.php" method="POST">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Matricule</label>
                                    </div>
                                    <div class="form-group form-primary">
