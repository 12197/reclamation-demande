...
<?php
     ...
     $sql = "SELECT nom , prenom FROM etudiant1 where login='".$_SESSION['log']."'";
...
?>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple">
                                                                  <?php
                                                $req=" SELECT id From reclamation where matriculeE='".$_SESSION['log']."' " ;
                                                $res=mysqli_query($cnx,$req); 
                                                $nb=mysqli_num_rows($res);
                                                echo $nb; ?></h4>
                                                                <h6 class="text-muted m-b-0">Réclamations</h6>
                                                            </div>
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Réclamations</p>
                                                            </div>
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">
                                                                  <?php
                                                $req=" SELECT id From reclamation where reponse ='En cours' and  matriculeE='".$_SESSION['log']."'  " ;
                                                $res=mysqli_query($cnx,$req); 
                                                $nb=mysqli_num_rows($res);
                                                echo $nb; ?></h4>
                                                                <h6 class="text-muted m-b-0">Non Traitée</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="fa fa-file-text-o f-28"></i>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                ...
                                                $req=" SELECT id From demande where matricule='".$_SESSION['log']."'  " ;
                                                $res=mysqli_query($cnx,$req); 
                                                $nb=mysqli_num_rows($res);
                                                echo $nb; ?></h4>
                                                                <h6 class="text-muted m-b-0">Demandes</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Demandes</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                ...
                                                $req=" SELECT id From demande where reponse ='En cours' and  matricule='".$_SESSION['log']."'  " ;
                                                $res=mysqli_query($cnx,$req); 
                                                $nb=mysqli_num_rows($res);
                                                echo $nb; ?> </h4>
                                                                <h6 class="text-muted m-b-0">Non Traitée</h6>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>Classe</th>
                                                                    <th>Année</th>
                                                                    <th class="text-right">Matricule</th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                <tr>
     ...
     $sql = "SELECT nom , prenom , classe , login FROM etudiant1 where login='".$_SESSION['log']."'";
     $req=mysqli_query($cnx,$sql);
...
?>
                                                                        <div class="d-inline-block align-middle">
                                                                            ...
                                                                            <div class="d-inline-block">
                                                                                <h6><?php echo $donnees ['nom'];?>&nbsp<?php echo $donnees ['prenom'];?></h6>
                                                                                <p class="text-muted m-b-0">Etudiant</p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td><?php echo $donnees ['classe'];?></td>
                                                                    <td>2022/2023</td>
                                                                    <td class="text-right"><label class="label label-danger"><?php echo $donnees ['login'];?></label></td>
                                                                </tr>
