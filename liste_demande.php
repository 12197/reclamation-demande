...
?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h5 class="m-b-10">Mes Demandes</h5>
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Mes Demandes</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                           ...
                                           <div class="card">
                                                    ...
                                                    <?php
                        $sql = "SELECT * FROM demande  where type= '".$id."' and matricule ='".$_SESSION['log']."'";
         ...
         ?>
                                            ...
                                            <tr>
                                                    ...
                                                    <td><?php echo $donnees ['datedemande'];?></td>
