                            ...
                            <ul class="pcoded-item pcoded-left-item">
                             <li class=" pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                                                    ...
                                                                    <?php  
                                                                            while($donns = mysqli_fetch_array($requete))
                                                                            {
                                                                            ?>

                                      <li class="">
                                          <?php echo "
                                          <a href=\"liste_reclamation.php?idrec=".$donns['nom']."\" class=\"waves-effect waves-dark\">
                                             "; ?>
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"><?php echo $donns ['nom'];?></span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <?php }?>
                                ...
                                <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                                                    ...
                                                                    <?php  
                                                                            while($donnes = mysqli_fetch_array($requete))
                                                                            {
                                                                            ?>

                                      <li class=""><?php echo "
                                          <a href=\"liste_demande.php?iddem=".$donnes['nom']."\" class=\"waves-effect waves-dark\">
                                             "; ?>
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"><?php echo $donnes ['nom'];?></span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <?php }?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h5 class="m-b-10">Passer Réclamation</h5>
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Réclamations</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                           ...
                                           <div class="card">
                                                    <div class="card-header">
                                                        <h5>Passer Réclamation</h5>
                                                        
                                                    </div>
                                                    <div class="card-block">
                                                        <h4 class="sub-title"></h4>
                                                        <form action="config/reclamation.php" method="POST">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Matricule Etudiant</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control  form-control-round" name="matricule" readonly value=<?php echo $donnees ['login'];?> >

                                                                    <input type="hidden" class="form-control  form-control-round" name="classe" readonly value=<?php echo $donnees ['classe'];?> >
                                                                </div>
                                                            </div>

                                                           
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Date à mettre dans l'attastation</label>
                                                                <div class="col-sm-10">
                                                                    <input type="date" class="form-control  form-control-round" name="dates" value="<?php echo date('Y-m-d'); ?>">

                                                                    <input type="hidden" class="form-control  form-control-round" name="nom" readonly value=<?php echo $donnees ['nom'];?> >
                                                                    <input type="hidden" class="form-control  form-control-round" name="prenom" readonly value=<?php echo $donnees ['prenom'];?> >
                                                                </div>
                                                            </div>
                                                                    <?php         
                                                                     $sql = "SELECT * FROM typereclamation";
                                                             ...
                                                             ?>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Type de réclamation </label>
                                                                <div class="col-sm-10">
                                                                    <select name="select" class="form-control form-control-round" >
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-2 col-form-label">Réclamation</label>
                                                                            <div class="col-sm-10">
                                                                                <textarea name="textes" rows="5" cols="5" class="form-control"
                                                                                placeholder="Ecrire votre réclamation içi .."></textarea>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-sm-10">
                                                                   <input type="submit" value="Envoyer" class="form-control  form-bg-primary">
                                                                </div> 
                                                            </div>
                                                                    </form>
