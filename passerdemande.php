                            ...
                            <ul class="pcoded-item pcoded-left-item">
                             <li class=" pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                                                    ...
                                                                    <?php  
                                                                            while($donneaes = mysqli_fetch_array($requete))
                                                                            {
                                                                            ?>

                                      <li class="">
                                          <?php echo "
                                          <a href=\"liste_reclamation.php?idrec=".$donneaes['nom']."\" class=\"waves-effect waves-dark\">
                                             "; ?>
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"><?php echo $donneaes ['nom'];?></span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <?php }?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h5 class="m-b-10">Passer Demande</h5>
                                    ...
                                    <div class="page-body">
                                           ...
                                           <div class="card">
                                                    <div class="card-header">
                                                        <h5>Passer Demande</h5>
                                                        
                                                    </div>
                                                    <div class="card-block">
                                                        <h4 class="sub-title"></h4>
                                                        <form action="config/demande.php" method="POST">
                                                            ...
                                                            <div class="form-group row">
                                                             ...
                                                             ?>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Type de Demande </label>
                                                                <div class="col-sm-10">
                                                                    <select name="select" class="form-control form-control-round" >
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                ...
                                                                                placeholder="Ecrire vos remarques içi .."></textarea>
                                                                            </div>
                                                                        </div>
